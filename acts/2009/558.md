...
- Version: `2011-05-01`
- LawVM tree hash: `1db4776592cea1a0e5c55b203f9b18c8b8784d972b2eac0e30200d17b167f221`
...
- [10 luku Muutoksenhaku](#chapter-10)
  ...
  - [85 § Erottamispäätöksen täytäntöönpano](#chapter-10-section-85)
...
Maksullisista koulutusohjelmista säädetään opetusministeriön asetuksella\.
...
- **6.** hyväksyä 48 §:n mukainen opetusministeriön kanssa tehtävä sopimus yliopiston puolesta;
...
Jos yliopistokohtaisia tavoitteita ei saada valtakunnallisesti tai alakohtaisesti yhteensovitetuiksi, opetusministeriö voi rahoituksen turvaamiseksi yksittäisen yliopiston osalta päättää määrällisistä ja laadullisista tavoitteista siltä osin kuin ne ovat yliopistolle osoitettavan rahoituksen perusteena\.
...
Opetusministeriö myöntää yliopistoille rahoitusta tässä laissa säädettyjen tehtävien toteuttamiseksi valtion talousarvioon otettavan määrärahan rajoissa\.
...
Edellä 2 momentissa tarkoitetun yliopistoindeksin laskemisesta ja kustannustason nousun huomioon ottamisesta sekä 3 momentissa tarkoitettujen rahoitusperusteiden laskennasta ja keskinäisestä jakautumisesta säädetään tarkemmin valtioneuvoston asetuksella\. Laskennallisin perustein myönnettävän rahoituksen perusteena olevista laskentakriteereistä säädetään opetusministeriön asetuksella\.
...
Opetusministeriö voi rahoittaa kaikkien yliopistojen yhteisiä toimintoja valtion talousarvioon otetun määrärahan rajoissa\.
...
Yliopiston tulee toimittaa opetusministeriölle sen määräämät koulutuksen ja tutkimuksen arvioinnin, kehittämisen, tilastoinnin ja muut seurannan ja ohjauksen edellyttämät tiedot ministeriön päättämällä tavalla\.
...
Edellä 49 §:n 3 momentissa tarkoitettu tuloksellisuusrahoitus maksetaan yliopistoille opetusministeriön päättämällä tavalla\.
...
Opetusministeriön on määrättävä maksettu rahoitus takaisin perittäväksi, jos yliopisto on:
...
- **3.** antanut opetusministeriölle väärän tai harhaanjohtavan tiedon seikasta, joka on ollut omiaan olennaisesti vaikuttamaan rahoituksen saantiin, määrään tai ehtoihin, taikka salannut sellaisen seikan; tai
...
Opetusministeriön on tehtävä takaisinperintää koskeva päätös kahden vuoden kuluessa siitä, kun opetusministeriön tietoon on tullut seikka, jonka nojalla rahoituksen maksamisen keskeyttämiseen tai lopettamiseen taikka rahoituksen perintään voidaan ryhtyä\. Päätös takaisinperinnästä on tehtävä kuitenkin viimeistään viiden vuoden kuluessa rahoituksen maksamisesta\.
...
Jos takaisin perittävää määrää ei makseta viimeistään opetusministeriön asettamana eräpäivänä, sille on maksettava vuotuista viivästyskorkoa korkolain 4 §:n 3 momentissa tarkoitetun korkokannan mukaan\.
...
### 85 § Erottamispäätöksen täytäntöönpano
