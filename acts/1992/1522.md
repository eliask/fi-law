...
- Statute: [`1522/1992`](<https://www.finlex.fi/fi/laki/ajantasa/1992/1522>)
- Version: `1992-12-23`
- LawVM tree hash: `46ac1c41448f042fdf871ef1b6ee7e75e4bc33f16cc4c2977b994e43366c2a1f`
...
- **4.** päättää opetusmaatilan hoidosta opetusministeriön määräämin perustein; sekä
...
Valtion oppilaitoksessa saadaan ammatillisessa peruskoulutuksessa sekä talouskoulussa käyttää opettamiseen, oppilaanohjaukseen, tukiopetukseen ja suunnitteluun 25 tuntia linjan vuosiluokkaa kohti viikossa\. Lisäksi saadaan käyttää enintään 1,2 tuntia viikossa opiskelijaa kohti\. Jos linjan vuosiluokalla on enemmän kuin 18 opiskelijaa, saadaan kuitenkin käyttää enintään 2,8 tuntia viikossa kutakin mainitun opiskelijamäärän ylittävää opiskelijaa kohti\. Oppilaitoksen käytettävissä on kutakin opetusviikkoa kohti joka tapauksessa vähintään tuntimäärä, joka saadaan, kun linjojen vuosiluokkien yhteismäärä kerrotaan luvulla 36,5\.
...
Valtion koti\- ja laitostalousoppilaitoksessa voi olla rehtorin virka sekä apulaisrehtorin ja lehtorin virkoja\. Lisäksi oppilaitoksessa voi olla virkasuhteisia tuntiopettajia ja tarpeellisia muita virkoja sekä tilapäisiä virkamiehiä ja työsopimussuhteista henkilökuntaa\.
...
Koti\- ja laitostalousoppilaitoksen yhteydessä voi olla opetuksen kannalta sopiva opetusmaatila\. Opetusmaatilalla tulee voida opetustarkoituksessa harjoittaa riittävän monipuolista maatila\- ja puutarhataloutta ja muita maaseutuelinkeinoja\.

<a id="section-46-subsection-2"></a>
#### \(2\)

Valtion opetusmaatilan hoidon perusteista päättää opetusministeriö\.
