...
- Statute: [`1048/2012`](<https://www.finlex.fi/fi/laki/ajantasa/2012/1048>)
- Version: `2013-01-01`
- LawVM tree hash: `e5531aa02ec55ef2587921ca96c3ae3d24c2db60d8fde497a4fedb67daf32f72`
...
- [14 § Taideyliopisto](#section-14)

- [15 § Aalto\-yliopisto](#section-15)

- [16 § Tampereen teknillinen yliopisto](#section-16)
...
- **2.** Master’s Degree Programme in European Forestry \(MMM/ FM\);

<a id="section-4-subsection-1-paragraph-3"></a>
- **3.** Master’s Degree Programme in Information Technology \(FM; yhteistyössä Lappeenrannan teknillisen yliopiston kanssa\);

<a id="section-4-subsection-1-paragraph-4"></a>
- **4.** Master’s Degree Programme in Color Informatics and Media Technology \(FM\);

<a id="section-4-subsection-1-paragraph-5"></a>
- **5.** Master’s Degree Programme \(CBU\) in Forestry and Environmental Engineering \(MMM; yhteistyössä Helsingin yliopiston ja Lappeenrannan teknillisen yliopiston kanssa\);

<a id="section-4-subsection-1-paragraph-6"></a>
- **6.** Master’s Degree Programme \(CBU\) in Information and Communication Technology \(FM; yhteistyössä Helsingin yliopiston ja Lappeenrannan teknillisen yliopiston kanssa\);

<a id="section-4-subsection-1-paragraph-7"></a>
- **7.** Sosiaali\- ja terveydenhuollon tietohallinnon maisteriohjelma \(TtM/YTM\);

<a id="section-4-subsection-1-paragraph-8"></a>
- **8.** Master’s Degree Programme in Public Health \(TtM; yhteistyössä Tampereen yliopiston kanssa\);

<a id="section-4-subsection-1-paragraph-9"></a>
- **9.** Master’s Degree Programme in Atmosphere\-Biosphere Studies \(FM; yhteistyössä Helsingin yliopiston kanssa\);

<a id="section-4-subsection-1-paragraph-10"></a>
- **10.** Master’s Degree Programme \(CBU\) in Public Health \(TtM\); sekä

<a id="section-4-subsection-1-paragraph-11"></a>
- **11.** Master’s Degree Programme in Early Language Education for Intercultural Communication \(KM\)\.
...
- **1.** Kulttuurienvälisen viestinnän maisteri\-ohjelma \(Master’s Degree Programme in Intercultural Communication\) \(FM\);
...
- **13.** Kansalaisyhteiskunnan asiantuntijuuden maisteriohjelma \(YTM/LitM/KM/FM\);
...
- **17.** Master’s Degree Programme in International Business and Entrepreneurship \(KTM\);
...
- **14.** Master’ s Degree Programme \(CBU\) in International Relations \(YTM\);

<a id="section-8-subsection-1-paragraph-15"></a>
- **15.** Arkistonhallinnan maisteriohjelma \(FM; yhteistyössä Jyväskylän yliopiston kanssa\); sekä

<a id="section-8-subsection-1-paragraph-16"></a>
- **16.** Master’s Degree Programme in European and Russian Studies \(YTM\)\.
...
- **12.** Master’s Degree Programme in Information Security and Cryptography \(FM/DI\);
...
Taideyliopistossa voi suorittaa seuraavat maisteriohjelmat:
...
- **2.** Taidehallinnon maisteriohjelma \(Master’s Degree Programme in Arts Management\) \(MuM\);

<a id="section-14-subsection-1-paragraph-3"></a>
- **3.** Master’s Degree Programme in Early Music \(MuM\);

<a id="section-14-subsection-1-paragraph-4"></a>
- **4.** Master’s Degree Programme in Global Music \(GLOMAS\) \(MuM\);

<a id="section-14-subsection-1-paragraph-5"></a>
- **5.** Master’s Degree Programme in Live Art and Performance Studies \(TeM\);

<a id="section-14-subsection-1-paragraph-6"></a>
- **6.** Koreografin maisteriohjelma \(tanssit\. maist\.\);

<a id="section-14-subsection-1-paragraph-7"></a>
- **7.** Nordiska Magisterprogrammet \(TKM\);

<a id="section-14-subsection-1-paragraph-8"></a>
- **8.** Tanssijan maisteriohjelma \(tanssit\. maist\.\);

<a id="section-14-subsection-1-paragraph-9"></a>
- **9.** Tanssinopettajan maisteriohjelma \(tanssit\. maist\.\); sekä

<a id="section-14-subsection-1-paragraph-10"></a>
- **10.** Teatteriopettajan maisteriohjelma \(TeM\)\.
...
<a id="section-16"></a>
### 16 § Tampereen teknillinen yliopisto
...
Tällä asetuksella kumotaan yliopistojen maisteriohjelmista annettu opetusministeriön asetus \(1474/2011\)\.
