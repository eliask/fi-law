...
- Version: `2013-01-01`
- LawVM tree hash: `c6f8b5536a242a91e699fdf4422b4d2642e353dbc28abe0a882e9c1be35d16e4`
...
Sikaryhmien yhdistämistä on vältettävä\. Jos sikaryhmiä kuitenkin joudutaan yhdistämään tai ryhmään joudutaan tuomaan uusia eläimiä, erityistä huomiota on kiinnitettävä sosiaalisten suhteiden uudelleenmuodostumisesta mahdollisesti aiheutuviin käyttäytymisongelmiin\. Sioilla on oltava riittävästi mahdollisuuksia piiloutua ja väistää muita sikoja\. Sikaryhmiä yhdistettäessä rauhoittavia lääkkeitä saadaan käyttää vain erityisestä syystä ja eläinlääkärin valvonnassa\.
